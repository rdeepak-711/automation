#!/usr/bin/env zsh
# generate-l1-plan-your-visit.sh — Generate L1 Plan Your Visit page for a site.
#
# Usage:
#   ./scripts/content/generate-l1-plan-your-visit.sh <site-slug> [--force]
#
# Examples:
#   ./scripts/content/generate-l1-plan-your-visit.sh amsterdam-canal-cruise
#   ./scripts/content/generate-l1-plan-your-visit.sh museo-del-prado --force
...
# ── Run assembler ─────────────────────────────────────────────────────────────
echo ""
echo "Generating L1 Plan Your Visit page for: $SITE_SLUG"
echo "──────────────────────────────────────────────────"
...
echo ""
echo "Output: output/$SITE_SLUG/l1-pages/plan-your-visit.html"
